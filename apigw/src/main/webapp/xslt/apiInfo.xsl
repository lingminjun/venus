            ...
            <head>
                ...
                <script type="text/javascript">
                    ...
                    */
                    ...
                    $("div [id='accountlogin_apis']").append("<span class='state_title'>ACCOUNT_LOGIN</span>");
                    ...
                    $("div [groupname='"+group_name+"']").each(function(index){
                        /* 分类各项接口安全级别 */
                        if ("integrated" == $(this).find("div[id='api_securityLevel'] span").text()) {
                        ...
                        } else if ("deviceAuth" == $(this).find("div[id='api_securityLevel'] span").text()) {
                        ...
                        } else if ("userAuth" == $(this).find("div[id='api_securityLevel'] span").text()) {
                            $("div [id='userlogin_apis']").append("<div class='api' groupname='"+group_name+"' ></div>");
                            $("div [id='userlogin_apis'] div.api:last").append($(this).html());
                        } else if ("accountAuth" == $(this).find("div[id='api_securityLevel'] span").text() || "secretAuth" == $(this).find("div[id='api_securityLevel'] span").text()) {
                            $("div [id='accountlogin_apis']").append("<div class='api' groupname='"+group_name+"' ></div>");
                            $("div [id='accountlogin_apis'] div.api:last").append($(this).html());
                            ...
                            <xsl:for-each select="/Document/apiList/api">
                                <div class="api">
                                    ...
                                    <div class="div_detail_toggle">
                                        <xsl:attribute name="onclick">method_click('d_<xsl:value-of select="methodDisplayName"/>', this)
                                        </xsl:attribute>
                                        <span class="api_name">
                                            <xsl:value-of select="methodDisplayName"/>
                                        </span>
                                    ...
                                    <div class="detail">
                                        <xsl:attribute name="id">d_<xsl:value-of select="methodDisplayName"/>
                                        </xsl:attribute>
                                                                ...
                                                                <xsl:choose>
                                                                    <xsl:when test="isList='true'">
                                                                        <xsl:choose>
                                                                            ...
                                                                            <xsl:otherwise>
                                                                                List&lt;<xsl:value-of select="display"/>&gt;
                                                                            </xsl:otherwise>
                                                                        </xsl:choose>
                                                                    </xsl:when>
                                                                    <xsl:otherwise>
                    ...
                    <div id="busi_err" class="div_comm_err">
                        ...
                        <xsl:if test="/Document/codeList/child::*">
                            <div class="tbl_err_code">
                                <table class="tbl_border_collapse">
                                    <tr>
                                        <th style="width:12%">服务(domain)</th>
