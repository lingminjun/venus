...
public class POJOSerializerProvider implements Opcodes {
    ...
    private static <T> Serializer<T> build(Class<T> clazz) {
        ...
        try {
            ...
            cw.visit(V1_6, ACC_PUBLIC + ACC_SUPER, c_name, "Ljava/lang/Object;Lcom/venus/apigw/serializable/Serializer<" + t_classDesc + ">;", "java/lang/Object",
            ...
            }
            {
                ...
                for (int i = 0; i < list.size(); i++) {
                    ...
                    pmv.visitFieldInsn(GETSTATIC, "com/venus/apigw/consts/ConstField", "UTF8", "Ljava/nio/charset/Charset;");
            ...
            if (GWConfig.isDebug) {
                ...
                try {
                    File folder = new File(GWConfig.getInstance().getAutogenPath() + File.separator + "POJOSerializer" + File.separator);
                    if (!folder.exists()) {
                        folder.mkdirs();
                    }
                    fos = new FileOutputStream(
                            GWConfig.getInstance().getAutogenPath() + File.separator + "POJOSerializer" + File.separator + className + ".class");
    ...
    private static void buildToXml(String cn, PocMethodVisitor pmv, Class<?> clazz, List<Field> fds, String classDesc, String t_className,
        ...
        for (Field fd : fds) {
            ...
            if (t == boolean.class || t == byte.class || t == short.class || t == char.class || t == int.class || t == long.class || t == float.class || t == double.class) {
                ...
                if (isCollection) {
                    ...
                    pmv.visitMethodInsn(INVOKESTATIC, "com/venus/apigw/serializable/POJOSerializerProvider", "writeXmlString",
                ...
                if (isCollection) {
                    ...
                    pmv.visitMethodInsn(INVOKESTATIC, "com/venus/apigw/serializable/POJOSerializerProvider", "getSerializer",
                                        "(Ljava/lang/Class;)Lcom/venus/apigw/serializable/Serializer;");
                    ...
                    pmv.loadArg(2); // load out
                    pmv.loadConst(0);
                    pmv.visitMethodInsn(INVOKEINTERFACE, "com/venus/apigw/serializable/Serializer", "toXml", "(Ljava/lang/Object;Ljava/io/OutputStream;Z)V");
                    writeXmlEnd(cn, pmv, name.endsWith("List") ? name.substring(0, name.length() - 4) : "item", 2, map, list);
                    pmv.visitJumpInsn(GOTO, label_loop);
                    pmv.visitLabel(label_finish);
                    writeXmlEnd(cn, pmv, name, 2, map, list);
        ...
        pmv.setLocal("e");//astore 4

        //26 ldc #7
        pmv.visitLdcInsn("");
        //28 invokestatic #8 <com/venus/esb/lang/ESBExceptionCodes.UNKNOWN_ERROR>
        pmv.visitMethodInsn(INVOKESTATIC,"com/venus/esb/lang/ESBExceptionCodes","UNKNOWN_ERROR","(Ljava/lang/String;)Lcom/venus/esb/lang/ESBException;");
        //31 aload 4
        pmv.loadLocal("e");
        //33 invokevirtual #9 <com/venus/esb/lang/ESBException.setCoreCause>
        pmv.visitMethodInsn(INVOKEVIRTUAL,"com/venus/esb/lang/ESBException","setCoreCause","(Ljava/lang/Throwable;)Lcom/venus/esb/lang/ESBException;");
    ...
    private static void buildToJsonWithFastJson(String cn, PocMethodVisitor pmv, Class<?> clazz, List<Field> fds, String classDesc,
        ...
        pmv.loadArg(2);
        pmv.loadArg(1);
        pmv.visitFieldInsn(GETSTATIC, "com/venus/apigw/serializable/Serializer$ApiSerializerFeature", "SERIALIZER_FEATURES", "[Lcom/alibaba/fastjson/serializer/SerializerFeature;");
