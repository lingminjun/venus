...
CREATE TABLE IF NOT EXISTS `bi_invoked_history` (
  ...
  `cip`  varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '客户端ip 255.255.255.255',
  ...
  `htm`  bigint NOT NULL COMMENT '调用时间，切分到小时' ,
  `tml`  int NOT NULL COMMENT 'terminal: pc端1, h5端2, iOS客户端3, android客户端4, 微信小程序5, 支付宝小程序6, 等等后续定义' ,
